package dev.gaphunter.ssrfunsanitizedurlcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.ssrfunsanitizedurlcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.ssrfunsanitizedurlcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "SSRF via Unsanitized URL Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34012-ssrf-via-unsanitized-url-companion/reviews"
